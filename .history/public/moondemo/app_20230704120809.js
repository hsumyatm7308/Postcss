...
<div class="grid lg:grid-cols-7  md:grid-cols-7 mb-2 shopcartboxscr">
...
<div
class="lg:col-span-1 md:col-span-1 h-full bg-stone-100 flex justify-center items-center minisubtotal shopcartboxscr-items ">
<span class="font-semibold ml-3 classheader">Subtotal : </span>

<div class="lg:col-span-1 md:col-span-1  flex justify-center items-center subtotal">
    <span class="">0$</span>
</div>
</div>
