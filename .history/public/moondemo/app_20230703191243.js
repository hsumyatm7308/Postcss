...
function addproducttocart(itemtit, itemimg, itemprice, total, curnum, index, isname) {
    ...
    cartshopbox.classList.add('w-[90%','lg:bg-transparent','md:bg-transparent','mb-4', 'shopcartboxes');
    var cartitems = document.querySelectorAll('.shopcart-items')[0];
    ...
    var itemsbox = `  <div
class="w-[90%]  lg:bg-transparent md:bg-transparent  mb-4 shopcartboxes">

<div class="grid lg:grid-cols-7  md:grid-cols-7 shopcartboxscr">


<div class="col-span-2 h-full bg-stone-100 flex justify-start items-center shopcartboxscr-items">
...
<div class="col-span-1 h-full bg-stone-100 flex justify-center items-center itemsprice shopcartboxscr-items">
    <span class="font-semibold ml-3 classheader">Price : </span>
    <span class="font-medium lg:text-lg md:text-md">${itemprice} $</span>
</div>

<div class="col-span-1 h-full bg-stone-100 flex justify-center items-center qtycontainer shopcartboxscr-items">
...
<div class="col-span-1 h-full bg-stone-100 flex justify-center items-center shopcartboxscr-items">
...
<div  class="col-span-1 h-full flex justify-center items-center item-remove shopcartboxscr-items">
    <button type="button"
