...
<div class="col-span-2 h-full bg-stone-100 flex justify-start items-center">
...
<div class="col-span-1 h-full bg-stone-100 flex justify-center items-center itemsprice">
    <span class="font-medium lg:text-lg md:text-md">${itemprice} $</span>
</div>

<div class="col-span-1 h-full bg-stone-100 flex justify-center items-center qtycontainer">
