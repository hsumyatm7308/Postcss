...
<div class="minisubtotal">
<div
    class="lg:col-span-1 md:col-span-1 h-full bg-stone-100 flex justify-center items-center  shopcartboxscr-items ">
    <span class="font-semibold  classheader">Subtotal : </span>

    <div
        class="lg:col-span-1 md:col-span-1  flex justify-center items-center subtotal">
        <span class="">0$</span>
    </div>
</div>
</div>
